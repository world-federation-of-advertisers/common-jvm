...
readonly CERT_PATH="${TESTDATA_DIR}/test_root.pem"
...
main() {
  ...
  # Check that certificate verifies itself when it is set as the CA.
  openssl verify -x509_strict -verbose -CAfile "${cert_file}" -verify_hostname "${HOSTNAME}" "${cert_file}"
