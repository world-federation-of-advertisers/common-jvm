...
/**
 * Reads bytes from the channel into [dst].
 *
 * @see AsynchronousByteChannel.read
 */
suspend fun AsynchronousByteChannel.readSuspending(dst: ByteBuffer): Int {
  return suspendCancellableCoroutine { continuation ->
    read(dst, continuation, intCompletionHandler)
  }
}

/**
 * Writes bytes from [src] into the channel.
 *
 * @see AsynchronousByteChannel.write
 */
suspend fun AsynchronousByteChannel.writeSuspending(src: ByteBuffer): Int {
  return suspendCancellableCoroutine { continuation ->
    write(src, continuation, intCompletionHandler)
  }
}
