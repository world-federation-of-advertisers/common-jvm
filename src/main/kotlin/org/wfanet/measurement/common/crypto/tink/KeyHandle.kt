...
open class KeyHandle internal constructor(internal val keysetHandle: KeysetHandle)

class TinkPublicKeyHandle internal constructor(keysetHandle: KeysetHandle) :
  PublicKeyHandle, KeyHandle(keysetHandle) {
...
class TinkPrivateKeyHandle internal constructor(keysetHandle: KeysetHandle) :
  PrivateKeyHandle, KeyHandle(keysetHandle) {
