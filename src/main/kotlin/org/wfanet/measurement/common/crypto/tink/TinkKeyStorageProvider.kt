...
class TinkKeyStorageProvider : KeyStorageProvider {
  ...
  override fun makeKmsPrivateKeyStore(store: Store<String>, keyUri: String): PrivateKeyStore {
    return EciesPrivateKeyStore(store, getKmsAead(keyUri))
  }
}
