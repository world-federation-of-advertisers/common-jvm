...
package org.wfanet.measurement.common.openid

import java.net.URLEncoder
import org.wfanet.measurement.common.identity.externalIdToApiId

/** Creates a request uri for an open id connect authentication request. */
fun createRequestUri(state: Long, nonce: Long, redirectUri: String, isSelfIssued: Boolean): String {
  ...
  with(URLEncoder.encode(redirectUri, "UTF-8")) {
    if (isSelfIssued) {
      uriParts.add("client_id=$this")
    } else {
      uriParts.add("redirect_uri=$this")
    }
  }
