...
private val instrumentation = invalidatableLazy {
...
internal constructor(
  ...
  /** Common [Meter]. */
  val meter: Meter = openTelemetry.getMeter(this::class.java.name)
  ...
  fun instrumentThreadPool(poolName: String, threadPool: ThreadPoolExecutor): ExecutorService =
    threadPools.instrument(poolName, threadPool)
