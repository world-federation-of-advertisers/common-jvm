...
fun <T> CoroutineScope.apiFuture(
  ...
  // Despite this being marked as an internal IP, this should be safe due to the fact that we're not
  // shading Guava.
  return ListenableFutureToApiFuture<T>(future(context, start) { block() })
}
