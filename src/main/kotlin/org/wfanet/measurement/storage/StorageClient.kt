...
interface StorageClient {
   ...
   *
   * When prefix and delimiter options are empty, all file names (blob keys) are returned.
   ...
   * not empty, the function returns full blob name for items that are directly under the current
