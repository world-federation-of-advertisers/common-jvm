...
class ProtoReflectionTest {
  ...
  fun `getFieldsRecursive returns fields`() {
    ...
    assertThat(fields.toList())
      .containsExactly(
        ProtoReflection.Field(message, embeddedMessagePath, message.getAnyValue(0)),
        ...
        ProtoReflection.Field(message, embeddedMessage2Path, message.getAnyValue(1)),
