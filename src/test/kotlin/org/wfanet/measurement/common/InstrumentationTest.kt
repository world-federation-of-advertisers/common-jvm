...
class InstrumentationTest {
  ...
  lateinit var metricExporter: InMemoryMetricExporter
  lateinit var metricReader: MetricReader
  ...
  @Test
  fun `instrumented does not instrument after shut down`() {
    val poolName = "thread-pool"
    val poolSize = 2
    val executor =
      ThreadPoolExecutor(poolSize, poolSize, 1L, TimeUnit.DAYS, LinkedBlockingQueue())
